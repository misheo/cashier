...
$AuthCopyWith<Auth> get copyWith => _$AuthCopyWithImpl<Auth>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Auth&&(identical(other.user, user) || other.user == user));
}
...
/// @nodoc
abstract mixin class $AuthCopyWith<$Res> implements $AuthStateCopyWith<$Res> {
